...
<html>
    ...
    <body>
        ...
        <form name="procuraProteinas" action="step04.php" method="post" enctype="multipart/form-data">
            <table border="0" align="center">
            <tr>
                <td align="center">
                    <font color="gray" size="2"><b><i>Proteins found</i></b></font><br />
                    <textarea name="proteinas" cols="80" rows="4"><?=$proteinasEncontradas?></textarea><br /><br />
                </td>
            </tr>
            <tr>
                <td align="center">
