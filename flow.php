        ...
        <center>
            ...
            <tr><td>
                ...
                <tr><td>
                    ...
                    To <b>load</b> a previously saved data mining, click the button <b>Choose...</b>, locate the corresponding XML file and click the button <b>Load</b>.
                    To <b>add</b> comments about the current data mining, use the text box <b>User comments</b> and click the button <b>Add</b>.
                    </font>
                </td></tr>
                </table>
            </td></tr>
            ...
            <tr height="100"><td>
                <center>
                    <a href="flow.php?$limpaFluxo=yes" target="fluxo" title="Clean flow">Clean flow</a>
                    ::
                    <a href="createXMLFlow.php" target="_blank" title="Download flow">Download flow</a>
                    <br /><br />

                    <font color="gray" size="2">
                    <b><i>Load flow</i></b><br />
                    <form name="loadFlowXML" action="flow.php" method="post" enctype="multipart/form-data">
                        <input type="file" size="20" name="flowXML" /><br /><br />
                        <input type="submit" name="load" value="Load" />
                    </form>

                    <b><i>User comments</i></b><br />
                    <form name="mostraRede" action="flow.php" method="get" enctype="multipart/form-data">
...
for($i = 0; $i < count($fluxo); $i++)
    echo '<a href="flow.php?$removeItem=' . $i . '" target="fluxo" title="' . $i . '">[remove]</a> ' . $fluxo[$i] . '<br />';
?>
