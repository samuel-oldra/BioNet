...
<?php
    foreach ($resp01[IdList][Id] as $idItem){
        ...
        // Apresenta a doença
        echo '<font size="2">';
        echo '<a href="step03.php?id=' . $resp02[DocSum][Id] . '" target="steps">' . $resp02[DocSum][Item][0][ItemContent] . '</a><br />';
        ...
        if ($resp02[DocSum][Item][3][ItemContent])
            echo 'Gene map locus <a href="http://www.ncbi.nlm.nih.gov/Omim/getmap.cgi?l' . $resp02[DocSum][Id] . '" target="_blank">' . $resp02[DocSum][Item][3][ItemContent] . '</a><br />';
        echo '</font><br />';
    }
